...
public class ContainerUtil {
  ...
  public static String ETCD_IMAGE_VERSION = "quay.io/coreos/etcd:v3.5.18";
  public static String MINIO_IMAGE_VERSION = "minio/minio:RELEASE.2024-05-28T17-19-04Z";
  public static String MILVUS_IMAGE_VERSION = "milvusdb/milvus:v2.5.18";
  ...
  private GenericContainer<?> initialEtcdContainer() {
    ...
    String command =
        "etcd -advertise-client-urls=http://etcd:2379 -listen-client-urls http://0.0.0.0:2379 " +
            "--data-dir /etcd ";
    return initialContainer(ETCD_IMAGE_VERSION, etcdEnv, command, ETCD_NET_ALIAS, 2379);
  }
  ...
  private GenericContainer<?> initialMinioContainer() {
    ...
    return initialContainer(
        MINIO_IMAGE_VERSION, minioEnv, command, MINIO_NET_ALIAS, 9000, 9001);
  }
  ...
  private GenericContainer<?> initialMilvusContainer() {
    ...
    return initialContainer(
        MILVUS_IMAGE_VERSION, milvusEnv, command, MILVUS_NET_ALIAS, 19530, 9091);
  }
