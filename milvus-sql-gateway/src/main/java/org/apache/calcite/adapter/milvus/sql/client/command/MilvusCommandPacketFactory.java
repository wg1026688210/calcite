...
/**
 * Factory for creating MySQL command packets from parsed payload.
 */
public final class MilvusCommandPacketFactory {

  private MilvusCommandPacketFactory() {
    // utility class
  }

  /**
   * Creates a MySQLCommandPacket from command type and payload.
   */
  public static MySQLCommandPacket createCommandPacket(MySQLCommandPacketType type,
